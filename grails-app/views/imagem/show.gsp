...
<html>
    ...
    <body>
        ...
        <div id="show-imagem" class="content scaffold-show" role="main">
            ...
            <f:display bean="imagem" />
            <g:form resource="${this.imagem}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.imagem}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
